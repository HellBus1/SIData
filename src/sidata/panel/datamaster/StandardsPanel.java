 ...
 * @author syubban
 */
public class StandardsPanel extends javax.swing.JPanel {
    ...
    private String [] columnName = {"Standard ID", "Standard Name", "Standard Description"};
    /**
     * Creates new form DevicesPanel
     */
    public StandardsPanel() {
//        initComponents();
        myInitsComponent();
    }
   ...
   private void myInitsComponent() {
        ...
        jTable1.setModel(new FinalItemTableModel(standardList, columnName));
        setTableListener();
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(final MouseEvent e) {
                if (e.getClickCount() == 1) {
                    ...
                    addDetailModalComponent(new Standard(
    ...
    private void addDetailModalComponent(Standard unit) {
        ...
        txtNames.setText(unit.getStandardName());
        
        txtId = new JTextField(16);
        txtId.setText(String.valueOf(unit.getStandardId()));
        txtId.setEnabled(false);
        
        txtDescriptions = new JTextField();
        txtDescriptions.setText(unit.getStandardDescription());
        ...
        edit.addMouseListener(
            new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 1) {
                        editFunc(new Standard(unit.getStandardId(), txtNames.getText(), txtDescriptions.getText()));
                    }
                }
            }
        );
    ...
    private void editFunc(Standard unit) {
        if(this.itemController.editNewStandard(unit)){
            resetContent("");
    ...
    private void addFunc() {
        Standard unit = new Standard();
        String name = txtName.getText();
        String description = txtDescription.getText();
        
        unit.setStandardName(name);
        unit.setStandardDescription(description);
        
//        System.out.println("namae : " + name);
        if(!name.equals("") && name != null) {
            if(this.itemController.addNewStandard(unit)){
                resetContent("");
    ...
    private void resetContent(String params) {
        standardList.clear();
        standardList.addAll(this.itemController.getListStandard(params));

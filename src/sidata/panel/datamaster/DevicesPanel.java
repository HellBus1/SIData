...
//        initComponents();
   ...
   private void myInitsComponent() {
        ...
        unitList.addAll(this.itemController.getListDevice(""));
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(final MouseEvent e) {
                if (e.getClickCount() == 1) {
                    ...
                    addDetailModalComponent(new Device(
    ...
    private void addDetailModalComponent(Device unit) {
        ...
        edit.addMouseListener(
            new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 1) {
                        editFunc(new Device(unit.getDeviceId(), txtNames.getText(), txtDescriptions.getText()));
                    }
                }
            }
        );
    ...
    private void editFunc(Device unit) {
        if(this.itemController.editNewDevice(unit)){
            resetContent("");
    ...
    private void addFunc() {
        ...
        unit.setDeviceName(name);
        unit.setDescription(description);
        
//        System.out.println("namae : " + name);
        if(!name.equals("") && name != null) {
            if(this.itemController.addNewDevice(unit)){
                resetContent("");
    ...
    private void resetContent(String params) {
        unitList.clear();
        unitList.addAll(this.itemController.getListDevice(params));

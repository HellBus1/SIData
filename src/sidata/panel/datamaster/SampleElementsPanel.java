 ...
 * @author syubban
 */
public class SampleElementsPanel extends javax.swing.JPanel {
    private ItemCtl itemController;
    private List<SampleElement> unitList;
    private JDialog addDialog, detailDialog;
    JFrame topFrame;
    private Label lblName, lblDescription;
    private JTextField txtName, txtDescription;
    private String [] columnName = {"Sample Element ID", "Sample Element Name", "Sample Element Description"};
    
    /**
     * Creates new form DevicesPanel
     */
    public SampleElementsPanel() {
//        initComponents();
        myInitsComponent();
    }
   ...
   private void myInitsComponent() {
        ...
        unitList.addAll(this.itemController.getListSampleElement(""));
        ...
        devices.setText("Sample Elements");
    ...
    private void addDetailModalComponent(SampleElement unit) {
        ...
        txtNames.setText(unit.getSeName());
        
        txtId = new JTextField(16);
        txtId.setText(String.valueOf(unit.getSeId()));
        txtId.setEnabled(false);
        
        txtDescriptions = new JTextField();
        txtDescriptions.setText(unit.getSeDescription());
        ...
        edit.addMouseListener(
            new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 1) {
                        editFunc(new SampleElement(unit.getSeId(), txtNames.getText(), txtDescriptions.getText()));
                    }
                }
            }
        );
    ...
    private void editFunc(SampleElement unit) {
        if(this.itemController.editNewSampleElement(unit)){
            resetContent("");
    ...
    private void addFunc() {
        SampleElement unit = new SampleElement();
        String name = txtName.getText();
        String description = txtDescription.getText();
        
        unit.setSeName(name);
        unit.setSeDescription(description);
        
//        System.out.println("namae : " + name);
        if(!name.equals("") && name != null) {
            if(this.itemController.addNewSampleElement(unit)){
                resetContent("");
    ...
    private void resetContent(String params) {
        unitList.clear();
        unitList.addAll(this.itemController.getListSampleElement(params));
